...
- (id)initWithTool:(CLTextTool*)tool
{
    ...
    if(self){
        ...
        [_deleteButton setImage:[tool imageForKey:kCLTextToolDeleteIconName defaultImageName:@"btn_close.png"] forState:UIControlStateNormal];
        ...
        _circleView.borderColor = c52168252;//[UIColor blackColor];
