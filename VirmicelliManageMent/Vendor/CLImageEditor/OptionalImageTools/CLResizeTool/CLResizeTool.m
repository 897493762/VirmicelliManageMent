...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        _infoPanel.backgroundColor = [UIColor colorWithWhite:1 alpha:0.8];//[[CLImageEditorTheme toolbarColor] colorWithAlphaComponent:0.9];
...
//    [_fieldW setTextColor:[CLImageEditorTheme toolbarTextColor]];
    [_fieldW setTextColor:[UIColor whiteColor]];
    _fieldW.backgroundColor = c52168252;
    _fieldW.layer.cornerRadius = _fieldW.frame.size.height/2;
...
//    [_fieldH setTextColor:[CLImageEditorTheme toolbarTextColor]];
    [_fieldH setTextColor:[UIColor whiteColor]];
    _fieldH.backgroundColor = c52168252;
    _fieldH.layer.cornerRadius = _fieldH.frame.size.height/2;
