...
- (void)setup
{
    ...
    _menuContainer.backgroundColor = [UIColor colorWithWhite:0.2 alpha:0.9];//[UIColor colorWithRed:58 green:61 blue:66 alpha:0.9];//
    ...
    _tonecurveView.gridColor  = [UIColor colorWithWhite:1 alpha:0.6];;//[UIColor colorWithWhite:0 alpha:0.2];
    _tonecurveView.pointColor = c52168252;//[UIColor colorWithWhite:0.5 alpha:1];
    _tonecurveView.lineColor  = c52168252;//[UIColor colorWithWhite:0.5 alpha:1];
